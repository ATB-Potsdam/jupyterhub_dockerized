...
c.DockerSpawner.extra_host_config.update({
    "extra_hosts": {
        "jupyterhub":"172.17.0.1",
    }
})

from subprocess import check_call
def user_bootstrap(spawner):
    username = spawner.user.name
    check_call(['/srv/jupyterhub/user-bootstrap.sh', username])

c.Spawner.pre_spawn_hook = user_bootstrap

# hub api ip and port must be defined in jupyterhub container to bind api to
c.JupyterHub.hub_ip = 'jupyterhub'
c.JupyterHub.hub_port = 8081

# mount persistent home to home in the container
c.DockerSpawner.volumes = { '/var/lib/jupyterhub/users/{username}': '/home/jovyan' }
c.Spawner.notebook_dir = '/home/jovyan'
c.Spawner.default_url = '/lab'

c.JupyterHub.authenticator_class = 'oauthenticator.github.GitHubOAuthenticator'

# you _must_ change the below settings
